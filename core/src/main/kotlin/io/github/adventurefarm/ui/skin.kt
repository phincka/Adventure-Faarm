package io.github.adventurefarm.ui
...
fun @SkinDsl Skin.loadButtonSkin(skin: Skin) {
    textButton(Buttons.TEXT_BUTTON.skinKey) {
        font = skin[Fonts.DEFAULT]
    }
}

fun @SkinDsl Skin.loadLabelSkin(skin: Skin) {
